...
model = tf.keras.Sequential([
    tf.keras.layers.Dense(1, input_shape=(1,)),  # Input shape should match the shape of your X data
...
plot_predictions_on_data(train_data=X_train, train_labels=y_train,  test_data=X_test, test_labels=y_test,  predictions=y_preds)
